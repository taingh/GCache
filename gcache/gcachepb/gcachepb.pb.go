...
func init() {
	proto.RegisterType((*Request)(nil), "gcachepb.Request")
	proto.RegisterType((*Response)(nil), "gcachepb.Response")
}

func init() { proto.RegisterFile("gcachepb.proto", fileDescriptor_889d0a4ad37a0d42) }
